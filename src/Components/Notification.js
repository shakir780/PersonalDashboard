...
const Notification = () => {
  ...
  return( 
  <div className="nav-item fixed right-5 md:right-32 top-16 bg-white dark:bg-[#0b0c0e] p-8 rounded-lg box-shadow w-72 md:w-96" >
    <div className="flex justify-between items-center">
      <div className="flex gap-3">
        <div className="font-semibold text-lg dark:text-gray-200">Notfications</div>
        <button style={{color:currentColor}} type="button" className=" text-xs rounded p-1 px-2 bg-orange-theme">5 New</button>
      </div>
